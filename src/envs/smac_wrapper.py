...
class SMACWrapper:
    ...
    def step(
        ...
        for idx, env in enumerate(self.envs):
            ...
            bad_transition = bool(episode_info.get("bad_transition", False) or episode_info.get("episode_limit", False))
            episode_info["bad_transition"] = bad_transition
            if terminated:
